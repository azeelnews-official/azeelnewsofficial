...
return getPublishedArticlesAsArticles(5);
...
const description =
`Latest ${category.name.toLowerCase()} news, analysis and updates — reported and verified by AZEEL NEWS.`;
