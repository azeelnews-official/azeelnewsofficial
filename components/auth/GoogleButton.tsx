export function GoogleButton({ label = "Continue with Google" }: { label?: string }) {
  return (
    <a
      ...
      className="flex w-full items-center justify-center gap-2.5 rounded-md border border-hairline bg-surface px-4 py-2.5 text-sm font-semibold text-ink-800 transition-colors hover:bg-ink-50"
    >
